...
<head>
    <title>Portal Login - inventory management system</title>
    <meta charset="UTF-8"/>
...
<div id="loginbox">
    <form name="form1" class="form-vertical" action="" method="post">
        ...
        <div class="form-actions">
            <center><input type="submit" name="submit1" value="Login" class="btn btn-success"/></center>
    ...
    if(isset($_POST["submit1"]))
    {
        ...
        $count=0;
        $res= mysqli_query($con, "select * from user_registration where username='$username' && password='$password' && role='user' && status='active'");
