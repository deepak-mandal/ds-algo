...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.customContextMenuRequested.connect(self.context_menu)      #to connect CCMR signal to the methods
    ...
    def context_menu(MainWindow):       #to context menu to show on right click------Display methods
