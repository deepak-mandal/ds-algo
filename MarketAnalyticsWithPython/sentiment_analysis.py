#Project-1 : TEXT MINING, SENTIMENT ANALYSIS USING PYTHON

'''
pip install tweepy textblob         #To install tweepy & textblob package!!
'''
...
#Load data
dataset = pd.read_csv('/home/deepak/analytics/Obama.txt')
