...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 20:32:40 2020
...
class SortedLinkedList(object):
    ...
    def insert_in_order(self, data):        #Inside this methods only position of new node will be decided, depending on its info value!!!
