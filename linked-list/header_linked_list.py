...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 18:16:17 2020
...
class HeaderLinkedList(object):
    ...
    def __init__(self):
        self.head=Node(0)       #we have taken a ref. 'head', that will always refers to the header node of the list
        
    def display_list(self):
        if self.head.link==None:    #means list is empty
            print('List is empty')
            return
